...
(function(){
  ...
  function boot(){
    ...
    function applyLayout(){W.forEach(function(it){it.p.style.gridColumn=it.cs+' / span '+it.w;it.p.style.gridRow=it.rs+' / span '+Math.max(it.h,Math.ceil((it.p.scrollHeight+16)/(40+16)));});}

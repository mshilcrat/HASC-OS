...
(function(){
  ...
  function boot(){
    ...
    function applyLayout(){W.forEach(function(it){it.p.style.gridColumn=it.cs+' / span '+it.w;var _fit=function(){it.p.style.gridRow=it.rs+' / span '+Math.max(it.h,Math.ceil((it.p.scrollHeight+16)/(40+16)));};_fit();if(!it.p.__wbRO&&typeof ResizeObserver!=='undefined'){it.p.__wbRO=new ResizeObserver(_fit);it.p.__wbRO.observe(it.p);}});}
